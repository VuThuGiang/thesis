...
border-bottom: 3px solid #30a5d0;
...
if (isset($_POST['appointment_id'])) {
    ...
    $sql_appointment = "INSERT INTO appointments (user_id, pet_id, service, appointment_date, appointment_time, additional_info) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt_appointment = $con->prepare($sql_appointment);
    $stmt_appointment->bind_param("iissss", $user_id, $pet_id, $service_id, $appointment_date, $appointment_time, $additional_info);
        ...
        <div class="main-content">
            <div class="container d-flex">
                <div class="content">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Dịch vụ:</strong> <?php echo htmlspecialchars($service_name); ?></p>
                                    <p><strong>Thú cưng:</strong> <?php echo htmlspecialchars($pet_name); ?></p>
                                    <p><strong>Ngày hẹn:</strong> <?php echo htmlspecialchars($appointment_date); ?></p>
                                    <p><strong>Thời gian:</strong> <?php echo htmlspecialchars($appointment_time); ?></p>
                                    <p><strong>Thông tin thêm:</strong> <?php echo htmlspecialchars($additional_info); ?></p>
                                    <p><strong>Giá:</strong> <?php echo number_format($price); ?> VND</p>
                                    <p><strong>Mã đơn hàng:</strong> <?php echo htmlspecialchars($order_number); ?></p>
                                </div>
                                <div class="col-md-6 d-flex justify-content-center align-items-center">
                                    <img id="qr_code" src="https://img.vietqr.io/image/MB-0971622398-compact.png
                                    ?amount=<?php echo $price; ?>
                                    &addInfo=MDH<?php echo number_format($order_number); ?>
                                    &accountName=<?php echo htmlspecialchars($full_name); ?>"
                                        alt="QR Code" class="img-fluid img-thumbnail" style="max-width: 300px;">
                                </div>
                            </div>
                    ...
                    <div class="mt-3">
                        <a href="history.php" class="btn btn-secondary">Xem lịch sử đặt lịch</a>
                        <a href="service.php" class="btn btn-secondary">Quay lại dịch vụ</a>
                    </div>
                </div>
            </div>
        </div>
